      ...
      <div class="card-body">
        ...
        <form action="{{ route('Culturalslider.update', ['Cultural' => $Cultural->id]) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" value="{{ old('title', $Cultural->title) }}" class="form-control" id="title" name="title" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" value="{{ old('link_title', $Cultural->link_title) }}" class="form-control" id="link_title" name="link_title" required>
          ...
          <div class="mb-3">
            ...
            <input type="url" value="{{ old('link_adress', $Cultural->link_adress) }}" class="form-control" id="link_adress" name="link_adress" required>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="body" name="body" rows="4" required>{{ old('body', $Cultural->body) }}</textarea>
