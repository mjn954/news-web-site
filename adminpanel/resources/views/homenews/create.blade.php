...
<body>
  <div class="container mt-5">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('homenews.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3">
            ...
            <input type="file" value="{{ old('movie') }}" class="form-control" id="movie" name="movie" required>
            @error('movie'){{$message}}@enderror
